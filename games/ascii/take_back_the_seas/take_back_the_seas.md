<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block " src="../../../games-imgcompressed/ascii/take_back_the_seas/images/intro.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block " src="../../../games-imgcompressed/ascii/take_back_the_seas/images/sidebar_1.png" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block " src="../../../games-imgcompressed/ascii/take_back_the_seas/images/sidebar_2.png" alt="Third slide">
    </div>
  </div>
