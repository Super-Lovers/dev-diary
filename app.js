                        ...
                        for (let month = 0; month < domTree.children[topic].children[year].children.length; month++) {
                            ...
                            for (let post = 0; post < domTree.children[topic].children[year].children[month].children.length; post++) {
                                ...
                                if (postName.substring(postName.length - 2, postName.length) == "md") {
                                    archiveNode += '    <li><i class="fas fa-align-left"></i> ' + '<a class="archive-link" href="' + '../../../../dom/' + domTree.children[topic].name.replace(' ', '%  20') + '/' + domTree.children[topic].children[year].name + '/' + domTree.children[topic].children[year].children[month].name + '/' +
                                        domTree.children[topic].children[year].children[month].children[post].name.substring(0, domTree.children[topic].children[year].children[month].children[post].name.length - 3).replace(' ', '%20') + '.html"><b>' + domTree.children[topic].children[year].children[month].children[post].name.substring(0, domTree.children[topic].children[year].children[month].children[post].name.length - 3) + "</b></a>";
                                }
                            }
                            // archiveNode += '</ul>';
                            // archiveNode += '    </li>';
